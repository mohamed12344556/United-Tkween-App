...
//     S.of(context).allTab,
//     S.of(context).booksTab,
//     S.of(context).mediaTab,
//   ];
...
//           SizedBox(height: 16.h),
//           Text(
//             state.errorMessage ?? S.of(context).libraryLoadError,
//             style: TextStyle(
//               color: AppColors.text,
...
//     return EmptyStateWidget(
//       icon: Icons.library_books_outlined,
//       title: S.of(context).emptyLibraryTitle,
//       message: S.of(context).emptyLibraryMessage,
//       buttonText: S.of(context).browseStore,
//       onButtonPressed: () {
//         context.pushNamed(Routes.hostView);
//       },
//       iconColor: AppColors.primary,
...
//             SizedBox(height: 16.h),
//             Text(
//               '${S.of(context).noSearchResults})} "${state.searchQuery}"',
...
//               onPressed: () => context.read<LibraryCubit>().clearSearch(),
//               icon: Icon(Icons.clear, size: 18.r),
//               label: Text(S.of(context).clearSearch, style: TextStyle(fontSize: 16.sp)),
//               style: TextButton.styleFrom(foregroundColor: AppColors.primary),
//             ),
//           ],
//         ),
...
class _LibraryViewState extends State<LibraryView>
  ...
  // Remove the field initializer and move tab titles to a getter or build method
